...
<div className="main_content_inner p-sm-0 ml-sm-1">
  ...
  <div className="pix-position-relative pix-grid" pix-grid>
    <div className="pix-width-1-3@m pix-flex-last@m pl-sm-0">
      <nav className="responsive-tab style-3 setting-menu pix-sticky" pix-sticky="top:30 ; offset:100; media:@m ;bottom:true; animation: pix-animation-slide-top" style={{}}>
        <ul>
          <li className="pix-active"><a href="#"> <i className="uil-cog" /> General </a></li>
      ...
      </nav><div className="pix-sticky-placeholder" style={{height: 520, margin: 0}} hidden />
    </div>
  ...
  <div className="course-intro-banner-info pix-light main_content_inner" style={{maxWidth: 1160}}>
    ...
    <h6>Social Links</h6>
      ...
      <div className="pix-card-default rounded mt-4">
        <div className="p-3">
          <h5 className="mb-0 text-left"> Social Link Info </h5>
        </div>
        <hr className="m-0" />
        <form className="pix-child-width-1-2@s pix-grid-small p-4 pix-grid" pix-grid>
          <div className="pix-first-column">
            <h5 className="pix-text-bold mb-2 text-left"> Facebook </h5>
            <input type="text" className="pix-input" />
          </div>
          <div>
            <h5 className="pix-text-bold mb-2 text-left"> Twitter </h5>
            <input type="text" className="pix-input" />
          </div>
          <div className="pix-grid-margin pix-first-column">
            <h5 className="pix-text-bold mb-2 text-left"> Instagram </h5>
            <input type="text" className="pix-input" />
          </div>
      
      
          <div className="pix-grid-margin pix-first-column">
            <h5 className="pix-text-bold mb-2 text-left"> Youtube </h5>
            <input type="text" className="pix-input"/>
          </div>
