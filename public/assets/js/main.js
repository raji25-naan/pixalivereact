	...
	$(document).ready(function () {
		...
		$(window).scroll(function () {
			if ($(window).scrollTop() >= pxShow) {
				$("#backtotop").addClass('visible pix-animation-slide-bottom');
			} else {
				$("#backtotop").removeClass('visible pix-animation-slide-bottom');
			}
		});
...
$('.pix-top-nav li a').each(function() {
	if (this.href === path) {
...
$(function(){
    ...
    var url = window.location.pathname, 
        ...
        $('.pix_channels_category ul li a').each(function(){
